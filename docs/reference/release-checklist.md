...
- Required local docs must exist: `README.md`, `docs/reference/install.md`, `docs/reference/commands.md`, `docs/reference/release-checklist.md`, `docs/reference/architecture.md`.
...
- Record verification results in `docs/features/release-packaging/implementation.md`.
