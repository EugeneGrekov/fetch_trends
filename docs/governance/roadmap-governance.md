...
Use exactly one lifecycle status per phase in `docs/governance/implementation-order.md`.
...
- `docs/features/<feature-name>/implementation.md` from [templates/implementation-note.md](templates/implementation-note.md).
...
Use [backlog-prioritization.md](backlog-prioritization.md) and
[templates/backlog-item.md](templates/backlog-item.md) when converting candidate
work into scored backlog items. Future implementation phases should normally
start there before they become plan documents in
...
Retirement must be explicit. Record the reason in the relevant plan, implementation note, or architecture document and update `docs/governance/implementation-order.md`.
...
Backlog prioritization has its own offline check:
