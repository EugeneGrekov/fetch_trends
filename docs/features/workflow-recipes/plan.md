...
- `README.md`
- `docs/reference/install.md` if it exists.
- `docs/reference/commands.md` if it exists.

Add links to `docs/recipes/README.md`.
...
- `docs/recipes/README.md` links to every recipe.
...
```text
docs/features/quality-hardening/plan.md
```
